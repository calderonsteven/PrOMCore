...
namespace PrOMCore.Windows.Controls
{
    public partial class PrOMTecladoControl : UserControl
    {
        public PrOMTecladoControl()
        {
            InitializeComponent();
            TextoTextBox.Focus();
        ...
        private void PrOMTeclado_KeyPress(object sender, KeyPressEventArgs e)
        {
